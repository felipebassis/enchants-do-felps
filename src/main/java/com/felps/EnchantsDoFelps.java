...
@Mod(EnchantsDoFelps.ID)
public class EnchantsDoFelps
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String ID = "enchants-do-felps";

    public EnchantsDoFelps() {

        MultiJumpHandler.getInstance().init();
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        MinecraftForge.EVENT_BUS.register(new MultiJumpCapabilitySyncHandler());
    }
